...
public interface LongArrayExtension {
  ...
  public static LongStream stream(long[] arr) {
	...
	public static long[] unboxed(Long[] arr) {
		long[] result = new long[arr.length];
		for (int i = 0; i < arr.length; i++) {
			result[i] = arr[i];
		}
	...
	public static long[] add(long[] arr, long l) {
		long[] result = Arrays.copyOf(arr, arr.length + 1);
		result[arr.length] = l;
		return result;
	}

	public static long[] add(long[] arr, int index, long l) {
		long[] result = Arrays.copyOf(arr, arr.length + 1);
	...
	public static long[] range(long[] arr, int from, int to) {
		long[] result = new long[to - from];
		System.arraycopy(arr, from, result, 0, to - from);
		return result;
	}

	public static long[] removeRange(long[] arr, int from, int to) {
	...
	public static long[] remove(long[] arr, long l) {
	...
	public static long[] removeAll(long[] arr, long... longs) {
	...
	public static long[] removeIf(long[] arr, LongPredicate predicate) {
		for (int i = 0; i < arr.length; i++) {
	...
	public static long[] retainAll(long[] arr, long... longs) {
		for (int i = 0; i < arr.length; i++) {
	...
	public static long[] retainIf(long[] arr, LongPredicate predicate) {
		for (int i = 0; i < arr.length; i++) {
			if (!predicate.test(arr[i])) {
				arr = removeIndex(arr, i--);
			}
	...
	public static OptionalLong find(long[] arr, LongPredicate condition) {
		for (long ele : arr) {
	...
	public static int findIndex(long[] arr, LongPredicate condition) {
		for (int i = 0; i < arr.length; i++) {
	...
	public static int findLastIndex(long[] arr, LongPredicate condition) {
	...
	public static boolean containsAll(long[] arr, long... longs) {
		for (long l : longs) {
	...
	public static boolean containsAny(long[] arr, long... longs) {
		for (long l : longs) {
	...
	public static long[] filter(long[] arr, LongPredicate condition) {
	...
	public static long[] map(long[] arr, LongUnaryOperator function) {
		long[] result = new long[arr.length];
		for (int i = 0; i < arr.length; i++) {
	...
	public static long[] filterMap(long[] arr, LongFunction<OptionalLong> function) {
		long[] tmp = new long[arr.length];
		int i = 0;
		for (long ele : arr) {
	...
	public static long[] filterMap(long[] arr, LongPredicate condition, LongUnaryOperator function) {
		long[] tmp = new long[arr.length];
		int i = 0;
		for (long ele : arr) {
	...
	public static long[] mapFilter(long[] arr, LongUnaryOperator function, LongPredicate condition) {
		long[] tmp = new long[arr.length];
		int i = 0;
		for (long ele : arr) {
	...
	public static long[] flattened(long[][] arr) {
		int size = 0;
		for (long[] a : arr) {
			size += a.length;
		}
	...
	public static long[] flatMap(long[] arr, LongFunction<long[]> function) {
		return flattened(mapToObj(arr, function, long[][]::new));
	}

	public static <T> T[] mapToObj(long[] arr, LongFunction<T> function, IntFunction<T[]> supplier) {
	...
	public static int[] mapToInt(long[] arr, LongToIntFunction function) {
	...
	public static double[] mapToDouble(long[] arr, LongToDoubleFunction function) {
	...
	public static OptionalLong reduce(long[] arr, LongBinaryOperator accumulator) {
	...
	public static long reduce(long[] arr, long identity, LongBinaryOperator accumulator) {
	...
	public static <R> R reduce(long[] arr, R identity, BiFunction<R,Long,R> accumulator) {
		R result = identity;
		for (long ele : arr) {
	...
	public static long[] distinctSorted(long[] arr) {
		long[] tmp = new long[arr.length];
		int j = 0;
		for (long ele : arr) {
